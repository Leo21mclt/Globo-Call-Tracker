(function () {
  if (window.__globoVideoSpyPageInstalled) return;
  window.__globoVideoSpyPageInstalled = true;
  try { (function(){})('Video accept spy page hook installed'); } catch (e) { }

  var MESSAGE_TYPE = window.__globoVideoSpyMessageType || "globo-video-accept";
  var acceptHookInstalled = false;
  ...
  function tryInstallAcceptHook() {
    if (acceptHookInstalled) return true;
    ...
    try {
      ...
      window.VideoInterpreterIndex.onVideoCallAcceptSuccess = function () {
        try {
          ...
          if (payload) {
            try { (function(){})("[VideoSpy] payload captured (hook)"); } catch (e) { }
          }
          post(payload);
        } catch (e) { }
        return original.apply(this, arguments);
      };
      acceptHookInstalled = true;
      try { (function(){})("[VideoSpy] accept hook installed"); } catch (e) { }
      return true;
    } catch (e) {
      return false;
    }
  ...
  var hookTimer = setInterval(function () {
    hookAttempts += 1;
    if (tryInstallAcceptHook() || hookAttempts > 60) {
    ...
    window.fetch = function () {
      return origFetch.apply(this, arguments).then(function (response) {
        try {
          ...
          logUrl("[VideoSpy fetch]", url);
          logDashboard("[VideoSpy dashboard fetch]", url);
          if (url && url.indexOf("/linguist_dashboard/video_call_accept") !== -1) {
            response
              ...
              .then(function (json) {
                ...
                if (payload) {
                  try { (function(){})("[VideoSpy] payload captured"); } catch (e) { }
                }
                post(payload);
              })
              .catch(function () {
                response
                  ...
                  .then(function (text) {
                    ...
                    var payload = extractPayload(json);
                    if (payload) {
                      try { (function(){})("[VideoSpy] payload captured (text)"); } catch (e) { }
                    }
                    post(payload);
                  })
                  .catch(function () { });
            ...
            response.clone().json().then(function (json) {
              ...
              if (payload) {
                try { (function(){})("[VideoSpy fetch] assignment payload captured"); } catch (e) {}
  ...
  XMLHttpRequest.prototype.send = function () {
    ...
    function handleXhrEnd() {
      ...
      try {
        ...
        if (isVideoAccept) {
          (function(){})("[VideoSpy xhr] Intercepted video_call_accept XHR!", url);
          var json = parseXhrJson(self);
          var payload = extractPayload(json);
          if (payload) {
            (function(){})("[VideoSpy xhr] payload successfully extracted:", payload);
            handled = true;
            post(payload);
          } else {
            (function(){})("[VideoSpy xhr] payload extraction failed. JSON:", json);
          }
        } else if (url.indexOf("assignments.json") !== -1) {
          var json = parseXhrJson(self);
          var payload = extractAssignmentPayload(json);
          if (payload) {
            (function(){})("[VideoSpy xhr] assignment payload extracted:", payload);
            handled = true;
            post(payload, "globo-assignment-start");
          }
        }
      } catch (e) {
        (function(){})("[VideoSpy xhr error]", e);
      }
    }
